  ...
  return (
    ...
    <div className={styles.main}>
        ...
        <div className={styles.p2}>
            <p className={styles.paragraph}>Techneed, established in 2019, is a software house offering expert services in WordPress development, graphic design, UI/UX design, and MERN stack applications. We deliver innovative solutions tailored to meet diverse client needs.
            </p>
        </div>
        </Row>
        <Row>
